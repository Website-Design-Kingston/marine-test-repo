var MainService = (function () {
  ...
  var journalDatas = [{
    itemCodes: [{
        itemCode: 0,
        itemName: "George A. Marsh",
        itemDetail: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto nisi omnis placeat tempore. ",
        shipDetail: "Lorem ipsum dolor sit amet, consectetur adipisicing elit.",
        conditionsDetail: "Lorem ipsum dolor sit amet, consectetur adipisicing elit.",
        pointPosition: "top: 44%; left: 12%",
        itemImage: {
          src: "img/wreck-diver/items/journal/placeholder.jpg"
        },
        itemImageAttachment: 'img/wreck-diver/items/georgeamarsh-boat.png',
        tabIndexNumber: 250
      },
      {
        itemCode: 11,
  ...
  return {
    ...
    attributeTabindexToDiscoveredItems:attributeTabindexToDiscoveredItems,
  ...
  //todo Implement dynamicattributetabindextodiscovereditem => //si le  div contenant la class bagItem a un element discovery a true, j'ajoute le tab index et les proprietes de border
  ...
  function attributeTabindexToDiscoveredItems() {
    var dive1ItemsDiscoveredElement = $('.bag > div[discover=true]');
    ...
    journalDatas.forEach(function (journalData, ind) {
      ...
      journalData.itemCodes.forEach(function (journalItem, index) {
        for(let i = 0; i < dive1ItemsDiscoveredElement.length; i++){
          let target = dive1ItemsDiscoveredElement[i];
          if (journalItem.itemCode === parseInt(target.getAttribute("data-item"))) {
            target.setAttribute("tabindex", journalItem.tabIndexNumber);
            break;
          };
        }
      });
  ...
  function journalHtmlBinding(journal) {
    $('.attachment-image--src', '.journal').attr({'src': journal.itemImageAttachment, 'alt':journal.itemName}); //Added this for the new journal attachment-image
    ...
    $('.item-image img', '.journal').attr({'src': journal.itemImage.src, 'alt':journal.itemName}); //Added this for the new journal item-image
