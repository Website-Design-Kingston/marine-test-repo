    ...
    var c = "Arrows." + b.SliderPro.namespace,
        d = {
            ...
            _arrowsOnUpdate: function() {
                var a = this;
                this.settings.arrows === !0 && null === this.$arrows ? (this.$arrows = b('<div class="sp-arrows"></div>').appendTo(this.$slidesContainer), this.$previousArrow = b('<span tabindex="2" class="sp-arrow sp-previous-arrow"></span>').appendTo(this.$arrows), this.$nextArrow = b('<span tabindex="3" class="sp-arrow sp-next-arrow"></span>').appendTo(this.$arrows), this.$previousArrow.on("click." + c, function() {
                    a.previousSlide()
