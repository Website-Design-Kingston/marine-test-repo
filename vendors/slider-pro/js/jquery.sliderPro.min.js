...
!function (a, b) {
    ...
    d.prototype = {
        _init: function () {
            ...
            if ("undefined" != typeof h) for (var i in h) {
                var j = h[i].substring(0, 1).toLowerCase() + h[i].substring(1) + "Defaults";
                "undefined" != typeof this[j] && b.extend(this.defaults, this[j])
            }
            if (this.settings = b.extend({}, this.defaults, this.options), "undefined" != typeof h) for (var k in h) "undefined" != typeof this["init" + h[k]] && this["init" + h[k]]();
